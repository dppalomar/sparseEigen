...
#rmarkdown::render("vignettes/SparseEigenvectors.Rmd", "bookdown::pdf_document2")
#rmarkdown::render("vignettes/SparseEigenvectors.Rmd", "bookdown::html_document2")
...
```{r, fig.width = 7, fig.height = 7, out.width = "80%", pngquant = "--speed=1"}
par(mfcol = c(3, 2))
...
```{r, fig.width = 5, fig.height = 6, out.width = "50%", pngquant = "--speed=1"}
par(mfcol = c(3, 1))
...
> **Algorithm 1**  
  ...
  3. Compute $\mathbf{V}_{\text{L}}$, $\mathbf{V}_{\text{R}}$ as the left and right singular vectors of 
