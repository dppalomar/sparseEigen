...
plot(res$sp.vectors[, 2]*sign(res$sp.vectors[sp_card+1, 2]), main = "Second Sparse Eigenvector", xlab = "Index", ylab = "", type = "h")
lines(V[, 2]*sign(V[SpCard+1, 2]), col = "red")
plot(res$sp.vectors[, 3]*sign(res$sp.vectors[2*sp_card+1, 3]), main = "Third Sparse Eigenvector", xlab = "Index", ylab = "", type = "h")
