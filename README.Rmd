...
This package provides functions to compute sparse eigenvectors (while keeping their orthogonality property) or sparse PCA from either the covariance matrix or directly the data matrix.
